        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 max-w-2xl mx-auto border-t-4 border-pink-500 animate-fade-in-up animation-delay-200">
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b-2 border-pink-100">
              ...
              <span className="text-gray-800 font-bold text-lg">Meezan Bank</span>
            </div>
            <div className="flex items-center justify-between py-3 border-b-2 border-pink-100">
              <span className="text-gray-600 font-bold uppercase tracking-wide text-sm">Account Title</span>
              <span className="text-gray-800 font-bold text-lg">Glowera Beauty</span>
            </div>
            <div className="flex items-center justify-between py-3 border-b-2 border-pink-100">
              <span className="text-gray-600 font-bold uppercase tracking-wide text-sm">Account Number</span>
              <span className="text-gray-800 font-bold text-lg font-mono">1234567890123456</span>
            </div>
            <div className="flex items-center justify-between py-3">
              <span className="text-gray-600 font-bold uppercase tracking-wide text-sm">IBAN</span>
              <span className="text-gray-800 font-bold text-lg font-mono">PK12MEZN0000001234567890</span>
            </div>
          </div>
          ...
          <form className="mt-8 space-y-6">
            ...
            <div>
              ...
              <label
                ...
                className="h-[150px] flex flex-col items-center justify-center border-2 border-dashed border-pink-300 rounded-2xl cursor-pointer text-gray-500 hover:text-pink-600 hover:border-pink-500 hover:bg-pink-50 transition-all duration-300"
              >
            ...
            {files && (
              <div className="mt-4 p-4 bg-pink-50 rounded-2xl animate-fade-in">
                ...
                <img
                  ...
                  alt="Preview"
                  className="mt-2 max-h-32 rounded-xl border-2 border-pink-200"
                />
              </div>
            )}
