      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="animate-fade-in-up">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-4xl bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">G</span>
              <span className="bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">LOWERA</span>
            </h2>
            <p className="text-gray-700 text-sm leading-relaxed mb-6">
              Premium beauty and skincare products for your natural glow. Discover the perfect blend of luxury and care.
            </p>
            {/* Social Icons */}
          ...
          <div className="animate-fade-in-up animation-delay-400">
            ...
            <ul className="space-y-3 text-sm text-gray-700">
              {["Track Order", "Returns & Exchanges", "Shipping Info", "FAQs", "Privacy Policy", "Terms & Conditions"].map((item, index) => (
                <li key={index}>
                  <a href="#" className="hover:text-pink-600 transition-colors flex items-center gap-2 group">
                    <span className="w-0 h-0.5 bg-gradient-to-r from-pink-500 to-rose-500 group-hover:w-4 transition-all duration-300"></span>
                    {item}
                  </a>
                </li>
        ...
        <div className="border-t-2 border-pink-200 pt-8 mb-8 animate-fade-in-up animation-delay-800">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-700 text-sm mb-6">Get exclusive offers and beauty tips delivered to your inbox!</p>
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              />
              <button className="px-8 py-3 rounded-full bg-gradient-to-r from-pink-500 to-rose-500 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t-2 border-pink-200 pt-6 text-center animate-fade-in-up animation-delay-1000">
          <p className="text-gray-700 text-sm">
            &copy; {new Date().getFullYear()} <span className="font-semibold bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">Glowera</span>. All rights reserved. Made with ❤️ for beauty lovers.
          </p>
        </div>
      </div>
    </footer>
