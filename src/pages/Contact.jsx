...
import { fetchCreateContact } from "../redux/slice/contactSlice";
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await dispatch(fetchCreateContact(formData));
      ...
      <div className="bg-gradient-to-br from-pink-100 via-rose-100 to-pink-200 min-h-[450px] w-full flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 animate-fade-in-up">
          ...
          <p className="text-gray-700 font-medium text-[16px] sm:text-[18px] lg:text-[20px] mt-6 max-w-3xl animate-fade-in animation-delay-400">
            ...
            products or need assistance, our team is here to help.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white rounded-3xl p-10 shadow-xl border-2 border-pink-100 animate-fade-in-up">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-pink-500 to-rose-500 text-white py-4 rounded-full font-bold uppercase cursor-pointer tracking-wide hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
              >
                Send Message
              </button>
            </form>
